...
<div class="form-group">
<div class="position-relative">
<label class="form-label"><i class="bi bi-geo-alt-fill"></i> <strong>Kota Tujuan</strong></label>
...
<div class="col-2">
<button type="submit" class="btn btn-lg btn-primary"> CEK TARIF &nbsp; <i class="bi bi-arrow-right-circle-fill"></i></button>
</div>
</form>
...
<p class="description">Dengan Agung Cargo kamu dapat dengan mudah mengirim barang kamu hanya perlu untuk menghubungi kami, kami akan datang
...
<img src="assets/img/about.jpg" width="85%" class="img-fluid" alt="" style="border-radius: 15px; opacity: 80%;">
</div>
<div class="col-lg-6 pt-0 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
<ul>
<li><i class="bx bx-store-alt"></i><h5 class="mt-4">Profil Perusahaan</h5></li>
...
<img src="assets/img/testimonials/Ismail.png" class="testimonial-img" alt="">
<h3>Ismail Peawa</h3>
<h4>Local Guide</h4>
<p>
...
<div class="swiper-slide">
<div class="testimonial-item">
<img src="assets/img/testimonials/ibenk.png" class="testimonial-img" alt="">
<h3>Ibenk Waryoko</h3>
<h4>Local Guide</h4>
<p>
<i class="bx bxs-quote-alt-left quote-icon-left"></i>
...
<div class="swiper-slide">
<div class="testimonial-item">
<img src="assets/img/testimonials/arif.png" class="testimonial-img" alt="">
<h3>Arif Maulana</h3>
<h4>Local Guide</h4>
<p>
<i class="bx bxs-quote-alt-left quote-icon-left"></i>
...
<li>
<div data-bs-toggle="collapse" class="collapsed question" href="#faq1">Apa kelebihan dari Agung Cargo?
<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
<div id="faq1" class="collapse" data-bs-parent=".faq-list">
<p>
Anda dapat dengan mudah mengetahui tarif pengiriman, dan mengecek drop point (kantor cabang) terdekat
dengan lokasi Anda melalui aplikasi dan website. Drop point Agung Cargo beroperasi setiap hari (termasuk weekend, dan Hari Libur Nasional).
</p>
</div>
</li>

<li>
<div data-bs-toggle="collapse" href="#faq2" class="collapsed question">Bagaimana sistem pembayaran Agung Cargo ?
<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
<div id="faq2" class="collapse" data-bs-parent=".faq-list">
<p>
Untuk pelanggan non-korporat, pembayaran harus dilakukan secara tunai pada saat pengiriman paket
melalui drop point. Untuk pelanggan korporasi, sistem pembayaran dapat dilakukan dengan syarat dan ketentuan khusus.
</p>
</div>
</li>

<li>
<div data-bs-toggle="collapse" href="#faq3" class="collapsed question">Apa yang perlu anda siapkan untuk pengiriman menggunakan Agung Cargo ?
<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
<div id="faq3" class="collapse" data-bs-parent=".faq-list">
<p>
Paket yang akan anda kirimkan adalah wajib dikemas dan dibungkus dalam keadaan baik atau layak
suatu kemasan tertutup (packing), serta telah diberikan data penerima secara lengkap,
...
<li>
<div data-bs-toggle="collapse" href="#faq4" class="collapsed question">Bagaimana anda melakukan klaim ?
<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
<div id="faq4" class="collapse" data-bs-parent=".faq-list">
<p>
Untuk proses klaim dapat menghubungi call center Agung Cargo (021) 6596509
Kemudian Anda bisa mengambil formulir klaim di drop point terdekat dan melengkapi semua persyaratan yang dibutuhkan.
</p>
</div>
</li>

<li>
<div data-bs-toggle="collapse" href="#faq5" class="collapsed question">Bagaimana cara kirim paket dengan jasa asuransi ?
<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
<div id="faq5" class="collapse" data-bs-parent=".faq-list">
<p>
Anda dapat memberi tahu admin drop point Agung Cargo bahwa Anda ingin mengasuransikan barang kiriman Anda.
Kemudian, Agung Cargo akan menghitung biaya asuransi paket Anda dengan perhitungan 0,2% dari harga invoice.
</p>
</div>
</li>

<li>
<div data-bs-toggle="collapse" href="#faq6" class="collapsed question">Bagaimana jika terjadi kerusakan dan kehilangan paket saat pengiriman ?
<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
<div id="faq6" class="collapse" data-bs-parent=".faq-list">
<p>
Jika Anda telah melakukan pembayaran asuransi dan melengkapi semua dokumen klaim,
maka Agung Cargo akan melakukan pembayaran klaim sesuai dengan nilai barang, maksimal Rp. 0,- (xx Rupiah).
</p>
</div>
</li>
