...
<section style="background-image:url('assets/img/testimonials-bg.jpg');background-repeat: repeat-space; padding-top:300px; position: relative;">
</section>


<!-- =========================== FORM CEK TARIF ================================================= -->    
<div class="container">
<div class="card" style="width: 900px;   margin-left:10%;   position: relatif; left: 50px; top: -5rem; box-shadow: 0px 5px 25px 0px rgba(0, 0, 0, 0.25); border-radius:15px;">
...
<div class="col-auto">
<button type="submit" class="btn btn-lg btn-primary mt-4"><i class="bi bi-search"></i> Cek Tarif</button>
</div>
</form>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              <H4>KONTAK KAMI</H4></p><p>
              <strong><i class="bi bi-geo-alt-fill"></i> Kantor Pusat</strong><br>
              Jl. Kebon Jeruk XV No.: 39 - 41, Maphar <br>
              Kec. Taman Sari, Kota Jakarta Barat, Daerah Khusus Ibukota Jakarta 11160 <br>Indonesia <hr/>
              </p>
              <p>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>SOSIAL MEDIA</h4>
            <p style="color:white">Follow Sosial Media Kami :</p></li>
